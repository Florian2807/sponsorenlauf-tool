...
"[project]/src/pages/api/students/[id].js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    try {
        ...
        if (!normalizedRawId || typeof normalizedRawId !== 'string') {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleError"])(res, new Error('Ungültige ID'), 400);
        }
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$validation$2e$js__$5b$api$5d$__$28$ecmascript$29$__["validateStudentId"])(normalizedRawId)) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleError"])(res, new Error('Ungültige ID'), 400);
        }
        if (normalizedRawId.startsWith('E')) {
            const replacement = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$database$2e$js__$5b$api$5d$__$28$ecmascript$29$__["dbGet"])('SELECT studentID FROM replacements WHERE id = ?', [
                parseInt(normalizedRawId.replace('E', ''), 10)
            ]);
            if (!replacement) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleNotFound"])(res, 'Ersatz-ID');
            }
        ...
        if (req.method === 'GET') {
            const student = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$studentService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["getPublicStudentById"])(id);
            if (!student) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleNotFound"])(res, 'Schüler');
            }
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleSuccess"])(res, student, 'Schüler erfolgreich abgerufen');
        } else if (req.method === 'POST') {
            const { vorname, nachname, klasse, geschlecht, timestamps, replacements } = req.body;
            const validationErrors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$validation$2e$js__$5b$api$5d$__$28$ecmascript$29$__["validateStudent"])({
                vorname,
                nachname,
                klasse,
                geschlecht
            ...
            if (timestamps !== undefined) {
                validationErrors.push(...(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$validation$2e$js__$5b$api$5d$__$28$ecmascript$29$__["validateTimestamps"])(timestamps));
            }
            if (validationErrors.length > 0) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleValidationError"])(res, validationErrors);
            }
            const existingStudent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$studentService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["getStudentById"])(id);
            if (existingStudent) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleError"])(res, new Error('Schüler mit dieser ID existiert bereits'), 409);
            }
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$studentService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["createStudent"])({
                id,
                vorname,
                nachname,
                klasse,
            ...
            if (timestamps?.length > 0) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$studentService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["updateRounds"])(id, timestamps);
            }
            if (replacements?.length > 0) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$studentService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["updateReplacements"])(id, replacements);
            }
            ...
            const student = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$studentService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["getStudentById"])(id);
            if (!student) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleNotFound"])(res, 'Schüler');
            }
            const mergedData = {
            ...
            const validationErrors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$validation$2e$js__$5b$api$5d$__$28$ecmascript$29$__["validateStudent"])(mergedData);
            if (validationErrors.length > 0) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleValidationError"])(res, validationErrors);
            }
            ...
            if (Object.keys(changedStudentFields).length > 0) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$studentService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["updateStudent"])(id, changedStudentFields);
            }
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleSuccess"])(res, null, 'Schüler erfolgreich aktualisiert');
            ...
            if (deleteRoundIndex !== undefined) {
                ...
                if (deleteRoundIndex < 0 || deleteRoundIndex >= timestamps.length) {
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleError"])(res, new Error('Ungültiger Index'), 400);
                }
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$studentService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["deleteRoundByIndex"])(id, deleteRoundIndex);
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleSuccess"])(res, null, 'Runde erfolgreich gelöscht');
            } else {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$studentService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["deleteStudent"])(id);
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleSuccess"])(res, {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleError"])(res, error, 500, 'Fehler bei der Schülerverarbeitung');
    }
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0jqz6sx._.js.map