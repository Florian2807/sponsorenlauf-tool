...
"[project]/src/pages/api/moduleConfig.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    try {
        if (req.method === 'GET') {
            const moduleConfig = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$settingsService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["getSetting"])('module_config', {
                donations: true,
                emails: true,
                teachers: true,
            ...
            if (doubleScanPrevention) {
                ...
                if (typeof doubleScanPrevention.timeThresholdMinutes !== 'number' || doubleScanPrevention.timeThresholdMinutes < 1 || doubleScanPrevention.timeThresholdMinutes > 60) {
                    return res.status(400).json({
                ...
                if (![
                    'confirm',
                    'block'
                ].includes(doubleScanPrevention.mode)) {
                    return res.status(400).json({
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$settingsService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["setSetting"])('module_config', moduleConfig);
            res.status(200).json({
                success: true,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleError"])(res, error, 500, 'Fehler beim Verarbeiten der Modul-Konfiguration');
    }
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__11rrlcq._.js.map