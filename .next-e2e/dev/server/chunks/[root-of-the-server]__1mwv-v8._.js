...
"[project]/src/pages/api/setupStatus.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handleGetSetupStatus(req, res) {
    try {
        ...
        const isSetupCompleted = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$settingsService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["getSetting"])('setup_completed', false);
        // Zusätzliche Checks für grundlegende Konfiguration
        const classStructure = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$settingsService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["getSetting"])('class_structure', {});
        const hasClassStructure = classStructure && Object.keys(classStructure).length > 0;
        const moduleConfig = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$settingsService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["getSetting"])('module_config', null);
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleError"])(res, error, 500, 'Fehler beim Abrufen des Setup-Status');
    }
}
async function handleCompleteSetup(req, res) {
    try {
        // Setze Setup als abgeschlossen
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$settingsService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["setSetting"])('setup_completed', true);
        // Setze Timestamp für Setup-Abschluss
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$settingsService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["setSetting"])('setup_completed_at', new Date().toISOString());
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleSuccess"])(res, null, 'Setup erfolgreich abgeschlossen');
    } catch (error) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiHelpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["handleError"])(res, error, 500, 'Fehler beim Abschließen des Setups');
    }
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1mwv-v8._.js.map