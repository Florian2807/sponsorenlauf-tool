  ...
  return (
    <div className={styles.container}>
      ...
      {showEditPopup && selectedStudent && (
        <div className={styles.popup}>
          <div className={styles.popupContent}>
            <button className={styles.closeButtonX} onClick={() => setShowEditPopup(false)}>
              &times;
            </button>
      ...
      {showAddPopup && (
        <div className={styles.popup}>
          <div className={styles.popupContent}>
            <button className={styles.closeButtonX} onClick={() => setShowAddPopup(false)}>
              &times;
            </button>
            ...
            <form onSubmit={addStudentSubmit}>
              ...
              />
              <div className={styles.popupButtons}>
                <button className={styles.redButton} onClick={() => setShowAddPopup(false)}>Abbrechen</button>
        ...
        <div className={styles.popup}>
          <div className={styles.popupContent}>
            ...
            <div className={styles.popupButtons}>
              ...
              <button
                onClick={() => { deleteStudent(); setShowConfirmDeletePopup(false); setShowEditPopup(false) }}
                className={styles.redButton}
              >
                Schüler löschen
              </button>
